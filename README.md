...
Right now it uses Yuzu and Ayako. Simply fork and change the .json with your favourite files (and update the json link on tenhou). Voicelines for several characters are already uploaded.
